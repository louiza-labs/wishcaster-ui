...
const Engagement = ({ tweetsAndCasts }: EngagementStatsProps) => {
  ...
  return (
    <div className="mx-auto">
      ...
      <div className="flex flex-row gap-4">
        {Object.keys(rawStatsMetricsForPosts).map((stat) => (
          <>
            {stat === "count" || stat === "likes" || stat === "replies" ? (
              <CardStat
                title={stat}
                value={rawStatsMetricsForPosts[stat]}
                key={stat}
              />
            ) : null}
          </>
